...
</title><link href="lib1/show_img.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="lib1/jquery-1.7.2.min.js.tải xuống"></script>
    <script src="lib1/Common.js.tải xuống" type="text/javascript"></script>
    <script src="lib1/PagingContent.js.tải xuống" type="text/javascript"></script>
<link rel="shortcut icon" type="image/png" href="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png"><link href="./WELCOME TO ICSSE 2017_files/lightbox.css" rel="stylesheet" type="text/css">
    <script src="lib1/lightbox.min.js.tải xuống" type="text/javascript"></script>
    <link href="lib1/search_Article.css" rel="stylesheet">
...
<link href="lib1/WebResource.axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="lib1/WebResource(1).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="lib1/WebResource(2).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"></head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDc3OGNiMzYwZWE2OBgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnUz4DBwj6yG0/4Ml/UD+RcA/gLHMw==">
</div>
...
<script src="lib1/WebResource(3).axd" type="text/javascript"></script>


<script src="lib1/Telerik.Web.UI.WebResource.axd" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="lib1/jsdebug" type="text/javascript"></script>
<script src="lib1/jsdebug(1)" type="text/javascript"></script>
<script src="lib1/jsdebug(2)" type="text/javascript"></script>
<script src="lib1/jsdebug(3)" type="text/javascript"></script>
<div>
...
<link href="lib1/main.css" rel="stylesheet">
<link href="lib1/mainPortlets.css" rel="stylesheet">
<script language="javascript" type="text/javascript">
    function SearchProcess(event) {
        if (event.keyCode == 13) {
            OnSearch(document.getElementById('txtSearchArticle').value);
		...
		<td colspan="2"><div id="pnTop">
			<div id="pnTopDisplay" style="width:1000px;float:left">
				<div id="ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3" style="width:574px;float:left"><div>
					<div class="P_top">
<div class="P_logo">
<div class="anh_logo"><img alt="" src="lib1/Banner Hoi nghi quoc te sua.jpg" style="width: 800px; height: 188px;"><br>
</div>
<div class="name_ute">
</div>
</div>
...
<link href="lib1/nivo-slider.css" rel="stylesheet">
<link href="lib1/default.css" rel="stylesheet">

<script src="lib1/jquery.nivo.slider.js.tải xuống"></script>
...
<div class="container" style="height:350px;">
    <div class="slider-wrapper theme-default">
        ...
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: block;">
                <img src="lib1/HNQT3.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="lib1/HNQT2.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="lib1/HNQT1.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <img class="nivo-main-image" src="lib1/HNQT3.jpg" style="display: inline; height: auto; overflow: hidden; width: 1000px;"><div class="nivo-caption"></div><div class="nivo-directionNav"><a class="nivo-prevNav">Prev</a><a class="nivo-nextNav">Next</a></div></div><div class="nivo-controlNav"><a class="nivo-control active" rel="0">1</a><a class="nivo-control" rel="1">2</a><a class="nivo-control" rel="2">3</a></div>
    </div>
</div>
<script>
...
<link href="lib1/Menu.Green.css" rel="stylesheet" type="text/css">
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="lib1/arrow_all_phong.png"></a>
    </div>
...
<strong><strong style="font-size: 14px;"></strong><strong style="font-size: 14px;"></strong><a href="http://icsse2017.hcmute.edu.vn/Resources/Docs/SubDomain/icsse2017/Instruction%20easychair_ICSSE2017.docx"><strong style="font-size: 14px;">EASYCHAIR&nbsp;</strong>SUBMISSION INSTRUCTION</a></strong></span>
	...
	background:url(lib1/bgfooter_phong.png) repeat-x;
	width:1000px;
	height:110px;">
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">4,504</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,982</span></p>
</div>
